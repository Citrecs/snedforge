...
export function MenuPage() {
  ...
  return (
    <div className="space-y-8">
      <section>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">LearnCard</h1>
      ...
      <section className="grid gap-4 sm:grid-cols-3">
        <Card>
          <p className="text-sm text-slate-500">Subject groups</p>
          <p className="mt-1 text-2xl font-semibold text-slate-900">{groups.length}</p>
        </Card>
        <Card>
          <p className="text-sm text-slate-500">Total questions</p>
          <p className="mt-1 text-2xl font-semibold text-slate-900">{totalQuestions}</p>
        </Card>
        <Card>
      ...
      <section>
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-slate-800">Subject groups</h2>
